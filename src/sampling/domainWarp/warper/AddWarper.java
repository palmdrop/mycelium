...
public interface AddWarper extends Warper {
    ...
    default AddWarper trigFunc(double offsetAngle, double xMultiplier, double yMultiplier, double amplitude, TrigFunc trigFunc) {
    ...
    default AddWarper domainWarp(HeightMap rotation, double offset) {
        return domainWarp(rotation, (x, y) -> 1.0, offset);
    }

    default AddWarper domainWarp(HeightMap rotation, HeightMap offset, double amount) {
        return domainWarp(rotation, offset, amount, amount);
    }

    default AddWarper domainWarp(HeightMap rotation, HeightMap offset, double min, double max) {
        return add(p -> {
