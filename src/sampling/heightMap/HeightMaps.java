...
public class HeightMaps {
    ...
    public static HeightMap constant(double value) {
        if(value < 0 || value > 1.0) throw new IllegalArgumentException();
        return (x, y) -> value;
    }
    ...
    public static HeightMap mult(HeightMap hm1, HeightMap hm2, double weight) {
    ...
    public static HeightMap mult(HeightMap hm, double value) {
    ...
    public static HeightMap add(HeightMap hm1, HeightMap hm2) {
    ...
    public static HeightMap pow(HeightMap baseMap, HeightMap power) {
