...
public class WarpedHeightMap extends SimpleDomainWarp<Double> implements HeightMap /*, DomainWarp<Double, WarpedHeightMap>*/ {
    public WarpedHeightMap(HeightMap heightMap, AddWarper warper) {
        super(heightMap, warper);
    }

    public WarpedHeightMap(HeightMap heightMap) {
    ...
    @Override
    public WarpedHeightMap domainWarp(HeightMap rotation, double offset) {
        super.domainWarp(rotation, offset);
        return this;
    }

    @Override
    public WarpedHeightMap domainWarp(HeightMap rotation, HeightMap offset, double amount) {
        super.domainWarp(rotation, offset, amount);
        return this;
    }

    @Override
    public WarpedHeightMap domainWarp(HeightMap rotation, HeightMap offset, double min, double max) {
