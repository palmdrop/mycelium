...
public class WeightedMap {
    ...
    public static WeightedMap mapFromGraphics(PGraphics g) {
        return mapFromGraphics(g, new Rectangle(0, 0, g.width, g.height));
    }

    public static WeightedMap mapFromGraphics(PGraphics g, Rectangle region) {
        return mapFromGraphics(g, region, c -> (float)(c >> 16 & 255));
    }
    public static WeightedMap mapFromGraphics(PGraphics g, Rectangle region, ColorToWeight converter) {
        g.loadPixels();
        ...
        WeightedMap wm = new WeightedMap(maxX - minX, maxY - minY);
